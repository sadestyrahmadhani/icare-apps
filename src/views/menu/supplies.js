                    ...
                    <div className="card-body">
                        <form onSubmit={this.submit}>
                            <div className="row">
                                ...
                                <div className="col-md-3 col-sm-6" style={{width:'141px', marginLeft:'95px'}}>
                                    <div className="check-item d-flex align-items-center mt-1" style={{height:'10%'}}>
                                        <input type="checkbox" className="consumable-checkbox me-2 form-check-input" id="drum-black" onChange={() => this.checkCheckBox('drumBlack')} ></input>
                                        <label style={{fontSize:'14px'}} htmlFor="drum-black">Drum Black</label>
                                    </div>
                                    <div className="check-item d-flex align-items-center mt-4" style={{height:'10%'}}>
                                        <input type="checkbox" className="consumable-checkbox me-2 form-check-input" id="drum-cyan" onChange={() => this.checkCheckBox('drumCyan')} ></input>
                                        <label style={{fontSize:'14px'}} htmlFor="drum-cyan">Drum Cyan</label>
                                    </div>
                                    <div className="check-item d-flex align-items-center mt-4" style={{height:'10%'}}>
                                        <input type="checkbox" className="consumable-checkbox me-2 form-check-input" id="drum-magenta" onChange={() => this.checkCheckBox('drumMagenta')} ></input>
                                        <label style={{fontSize:'14px'}} htmlFor="drum-magenta">Drum Magenta</label>
                                    </div>
                                    <div className="check-item d-flex align-items-center mt-4" style={{height:'10%'}}>
                                        <input type="checkbox" className="consumable-checkbox me-2 form-check-input" id="drum-yellow" onChange={() => this.checkCheckBox('drumYellow')} ></input>
                                        <label style={{fontSize:'14px'}} htmlFor="drum-yellow">Drum Yellow</label>
                                    </div>
                                    <div className="check-item d-flex align-items-center mt-4" style={{height:'10%'}}>
                                        <input type="checkbox" className="consumable-checkbox me-2 form-check-input" id="fuser-web" onChange={() => this.checkCheckBox('fuserWeb')} ></input>
                                        <label style={{fontSize:'14px'}} htmlFor="fuser-web">Fuser Web</label>
                                    </div>
                                    <div className="check-item d-flex align-items-center mt-4" style={{height:'10%'}}>
                                        <input type="checkbox" className="consumable-checkbox me-2 form-check-input" id="corotron" onChange={() => this.checkCheckBox('corotron')} ></input>
                                ...
                                <div className="col-md-6 col-sm-12 mb-4 p-0">
                                    ...
                                    <div className="d-none col-md-6 col-sm-8 mx-auto my-5" id="display-image-meter">
                                ...
                                <div className="col-md-6 col-sm-12 mb-4 p-0">
                                    ...
                                    <div className="d-none col-md-6 col-sm-8 mx-auto my-5" id="display-image-status">
