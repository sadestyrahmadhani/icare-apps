            ...
            <div className="container">
                ...
                <div className="card shadow border-0" style={{borderRadius:'20px'}}>
                    <div className="card-body">
                        <div className="card shadow border-0 mt-2" style={{borderRadius:'15px'}}>
                            <div className="card-body">
                                <div className="card-label py-1">
                                    <label style={{fontWeight: 'bold'}}>No EQ</label>
                                </div>
                                <input type="text" className="py-1 border-only-bottom" style={{fontSize: '14px', width: '-webkit-fill-available'}}/>
                            </div>
                        </div>
                        ...
                        <div className="card shadow border-0 mt-4 pb-5" style={{borderRadius:'15px'}}>
                            <div className="card-body">
                                <div className="card-label py-1">
