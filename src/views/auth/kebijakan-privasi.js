            ...
            <div className="bg-light">
                ...
                <div className="text-center pt-4 mb-5">
                    <div className="responsive-bar">
                        <div className="card-title mx-auto my-0 my-md-3" style={{borderBottom:'3px solid #014C90', width:'155px'}}>
                            <h5 className="title-icare fw-bold m-0 p-0">Kebijakan Privasi</h5>
                        </div>
                    </div>
                    <div className="card text-center p-4 mx-auto mb-md-2 mb-0 bg-light col-md-7 col-11 custom-card" style={{border:'1px solid', borderRadius:'30px'}}>
                    ...
                    <p className="text-danger mb-md-3 m-0" style={{fontSize:'14px'}}><u>&#42;Mohon baca sepenuhnya kebijakan ini</u></p>
                    {   
