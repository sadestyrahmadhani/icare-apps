...
function ConditionRegister(props) {
    ...
    return(
        <div className="text">
            ...
            <Link className={ `btn btn-login fw-medium rounded-3 ${ isCheck ? 'disabled' :'' }` } style={{fontSize:'14px', paddingLeft:'60px', paddingRight:'60px', paddingTop:'12px', paddingBottom:'12px'}} to="/register" >SUBMIT</Link>
        </div>
    )
} 
