        ...
        <>
                <div className="responsive-bar">
                    <div className="card-title mx-auto my-md-3 my-0" style={{borderBottom: '3px solid #014C90', width: '164px'}}>
                                    ...
                                    <div className="mt-2 mb-3">
                                        <div className="row">
                                            ...
                                            <div className="col-4 d-block d-md-none">
                                                <label className={`mb-1 btn btn-login btn-photo ${ idCard > 0 ? 'd-none' : '' }`} htmlFor="inputFiles" style={{padding: '10px 40px'}}>Foto KTP</label>
                                                <input type="file" className="form-control border-0 d-none" id="inputFiles" onChange={handleFileInputIdCard} accept="image/*" />
                                                <button onClick={ removeFileInputIdCard } className={`btn btn-outline-danger btn-sm text-primary rounded-3 btn-photo-mobile ${ idCard > 0 ? '' : 'd-none' }`}>Hapus Foto KTP</button>
                                            </div>
                                    ...
                                    <div className="mt-2 mb-3">
                                        <div className="row">
                                            ...
                                            <div className="col-5 d-block d-md-none">
                                                <label className={`btn-selfie mb-1 btn btn-login ${ selfiePhoto > 0 ? 'd-none' : '' }`} htmlFor="inputFilesSelfie" style={{padding: '10px 40px'}}>Selfie dengan KTP</label>
                                                <input type="file" className="form-control border-0 d-none" id="inputFilesSelfie" onChange={handleFileInputSelfiePhoto} accept="image/*" />
                                                <button className={`btn btn-outline-danger btn-sm text-primary rounded-3 btn-selfie ${ selfiePhoto > 0 ? '' : 'd-none' }`} onClick={removeFileInputSelfiePhoto}>Hapus Foto Selfie KTP</button>
                                            </div>
                        ...
                        <ConfirmAlert visible={showPopup} message={alertOption.message} onClick={handlePopup} customClass="col-md-4 col-sm-6 col-9" />
                </div>
        </>
    )
}
