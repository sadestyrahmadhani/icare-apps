      ...
      <>
        <div className="header">
          <div className="container mb-5 d-flex mt-2">
            <div className="col-6">
              <h4
                className="title-icare fw-bold"
                style={{ borderBottom: "4px solid #014C90", width: "210px" }}
              >
                Pengaturan Alamat
              </h4>
            </div>
              ...
              <div className="col-7">
                <form className="d-flex">
                  <span className="my-auto" style={{ color: "#014C90" }}>
                    <i className="fa fa-search fa-fw fa-lg"></i>
                  </span>
                  <input
                    type="search"
                    className="form-control me-3 border-0 border-only-bottom"
                    style={{ fontSize: "16px" }}
                  />
                </form>
              </div>
                  ...
                  <table className="table table-borderless mb-0">
                    <thead>
                      ...
                      <i
                        ...
                        style={{ marginRight: "5px" }}
                      ></i>{" "}
                      <span className="title-icare fs-6"> Sudah Pinpoint</span>
                    </thead>
                  </table>
                </div>
                <div className="col-md-6 col-sm-6 col-12 text-end">
                  ...
                  <div className="">
                    <ol className="title-icare mb-0">
                      ...
                      <li className="nav-item">
                        <Link className="nav-link" to="/form-address">
                          Ubah
                        </Link>
                      </li>
                      <li className="nav-item">
          ...
          <div className="card shadow-sm rounded m-5">
            <div className="card-body px-3">
              <h6 className="card-title title-icare fw-bold">
                Kantor Pusat Cabang 2
              </h6>
              <div className="row fw-bold">
                <div className="col-6">
                  <p className="mb-0" style={{ fontSize: "14px" }}>
