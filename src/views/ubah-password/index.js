                                ...
                                <form onSubmit={this.submit}>
                                    <div className="mb-3">
                                        ...
                                        <div className="d-flex border border-dark">
                                            <input type={ this.state.typeInput[0] } className="form-control border-only-bottom" style={{boxShadow: 'none', textDecoration: 'none', marginLeft: '10px'}}/>
                                            <i 
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="border border-dark d-flex">
                                            <input type={ this.state.typeInput[1] } className="form-control border-only-bottom" style={{boxShadow: 'none', textDecoration: 'none', marginLeft: '10px'}}/>
                                            <i 
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="d-flex border border-dark">
                                            <input type={ this.state.typeInput[2] } className="form-control border-only-bottom" style={{boxShadow: 'none', textDecoration: 'none', marginLeft: '10px'}}/>
                                            <i 
