                ...
                <div style={{position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, .4)', zIndex: '11111', display: this.props.visible ? 'flex' : 'none', alignItems: "center", justifyContent: "center"}}>
                    <div className={customClass}>
                        <div className="card rounded-4">
                            <div className="card-body p-5" style={{fontSize:'14px', marginLeft:'10px'}}>
                                <button onClick={onClick} style={{background:'none', border:'none', marginLeft:'98%', fontSize:'20px'}}><i className="fa fa-close"></i></button>
                                <div className="text-center mb-4">
                                    <img src={dataInformation.imgInformation} alt="Image" style={{width:'20%'}}></img>
                                </div>
